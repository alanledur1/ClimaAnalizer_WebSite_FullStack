...
function ApiTempChuva({ onSelectData, isDark }) {
  ...
  const handleOptionSubmit = async () => {
    try {
      switch (option) {
        case '1':
          const responseAll = await axios.post('https://clima-i3wssd7gnq-rj.a.run.app/api/mes-dia-chuvoso', {
          ...
          break;
        case '2':
          const responsePrecip = await axios.post('https://clima-i3wssd7gnq-rj.a.run.app/api/mes-dia-chuvoso', {
          ...
          break;
        case '3': 
          const responseTemp = await axios.post('https://clima-i3wssd7gnq-rj.a.run.app/api/mes-dia-chuvoso', {
