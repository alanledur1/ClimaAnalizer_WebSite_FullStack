...
function ApiTempChuva({ onSelectData, isDark }) {
  ...
  const handleOptionSubmit = async () => {
    try {
      switch (option) {
        case '1':
          const responseAll = await axios.post('https://crack-parser-431201-a7.rj.r.appspot.com/api/mes-dia-chuvoso', {
          ...
          break;
        case '2':
          const responsePrecip = await axios.post('https://crack-parser-431201-a7.rj.r.appspot.com/api/mes-dia-chuvoso', {
          ...
          break;
        case '3': 
          const responseTemp = await axios.post('https://crack-parser-431201-a7.rj.r.appspot.com/api/mes-dia-chuvoso', {
